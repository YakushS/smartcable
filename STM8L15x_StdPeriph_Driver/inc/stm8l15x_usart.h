...
/**
  * @brief USART LIN Break detection length possible values
  */
typedef enum
{
...
/**
  * @brief Macro used by the assert_param function in order to check the different
  *   sensitivity values for the FLAGs that can be cleared by software writing 0
  */
...
/**
 * @brief Macro used by the assert function in order to check the different
 *  sensitivity values for the USART MODE
 */
...
/**
 * @brief Macro used by the assert function in order to check the different
 *  sensitivity values for the WordLength
 */
...
/**
 * @brief Macro used by the assert_param function in order to check the different
 *  sensitivity values for the IrDAMode
 */
#define IS_USART_IRDAMODE(IrDAMode) \
  (((IrDAMode) == USART_IrDAMode_LowPower) || \
   ((IrDAMode) == USART_IrDAMode_Normal))

/**
 * @brief Macro used by the assert function in order to check the different
 *  sensitivity values for the DMA request
 */
#define IS_USART_DMAREQ(DMAReq) ((((DMAReq) & (uint8_t)0x3F) == 0x00) && ((DMAReq) != (uint8_t)0x00))

/**
  * @brief Macro used by the assert_param function in order to check the different
  *   sensitivity values for the USART Clock
  */
#define IS_USART_CLOCK(CLOCK) (((CLOCK) == USART_Clock_Disable) ||((CLOCK) == USART_Clock_Enable))

/**
  * @brief Macro used by the assert_param function in order to check the different
  *  sensitivity values for the USART Clock Polarity
  */
#define IS_USART_CPOL(CPOL) (((CPOL) == USART_CPOL_Low) || ((CPOL) == USART_CPOL_High))

/**
  * @brief Macro used by the assert_param function in order to check the different
  *   sensitivity values for the USART Clock Phase
  */
#define IS_USART_CPHA(CPHA) (((CPHA) == USART_CPHA_1Edge) || ((CPHA) == USART_CPHA_2Edge))

/**
  * @brief Macro used by the assert_param function in order to check the different
  *   sensitivity values  for the USART Last Bit
  */
...
/**
  * @brief Macro used by the assert function in order to check the different
  *   sensitivity values for the WakeUp
  */
...
/**
  * @brief Macro used by the assert function in order to check the different
  *  sensitivity values for the USART_StopBit
  */
